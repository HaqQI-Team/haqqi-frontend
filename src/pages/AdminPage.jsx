  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <nav className="mt-8 space-y-2" aria-label={t("admin.navLabel")}>
        <span className="flex w-full items-center gap-3 rounded-md bg-red-900 px-3 py-2.5 text-start text-sm font-bold text-white shadow-sm dark:bg-red-700">
          <FontAwesomeIcon icon={faFilePdf} className="w-4 shrink-0" />
